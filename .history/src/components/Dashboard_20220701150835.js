            ...
            {todos.map((todo) => {
                return (
                    <div>
                        <br/>
                        <br/>
                    <div className="container border bg-primary">
                        <br/>
                        <p>business name : </p> <h3>{todo.call.businessName}</h3>
                        <p>owner name : </p> <h3>{todo.call.ownerName}</h3>
                        <p>phone : </p> <h3>{todo.call.phone}</h3>
                        <p>issues : </p> <h3>{todo.call.issues}</h3>
                        <p>notes : </p> <h3>{todo.call.notes}</h3>
                        <p>URL : </p> <h3>{todo.call.URL}</h3>
