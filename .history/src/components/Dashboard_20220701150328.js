        ...
        <div className="container border">
            {todos.map((todo) => {
                return (
                    <div className="container border">
                        <br/>
                        <p>business name : {todo.call.businessName}</p>
                        <p>owner name : {todo.call.ownerName}</p>
                        <p>phone : {todo.call.phone}</p>
                        <p>issues : {todo.call.issues}</p>
                        <p>notes : {todo.call.notes}</p>
                        <p>URL : {todo.call.URL}</p>
                    </div>
                )
            })}
        </div>
