    ...
    <div>
        ...
        <Form className="container border">
            ...
            <div className="check-section">
                <Form.Group className="mb-3" controlId="yes">
                    <Form.Check type="checkbox" label="yes" className="float-start" />
                </Form.Group>
                <Form.Group className="mb-3" controlId="callback">
                    <Form.Check type="checkbox" label="callback" className="float-start" />
                </Form.Group>
                <Form.Group className="mb-3" controlId="maybe">
                ...
                <Form.Group className="mb-3" controlId="notAvailable">
